package org.lenic.jboot.mybatis.service;

import java.util.Date;
import java.util.List;

import org.lenic.jboot.mybatis.mapper.MessageMapper;
...
public class MessageService {
	...
	public void createMessage(Message message) {
		...
		String max = messageMapper.selectByExample(example).get(0).getId();
